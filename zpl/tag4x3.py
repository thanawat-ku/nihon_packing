...
for i in range(2,31):
    ...
    ^FO100,82^BY2^BCN,40,N^FD3511-PC2T-0000^FS
    ...
    ^FO50,435^FD(1T)^FS
    ^FO100,452^BCN,40,Y,Y^FDL000000000001^FS
    ^FO50,500^FDSerial Number^FS
    ^FO50,535^FD(S)^FS
    ^FO100,552^BCN,40,Y,Y^FDT000000000001^FS
    ^FO550,500^FDCOO^FS
    ^CF0,80
    ^FO600,530^FDTH^FS
    ...
    ^FO520,50
    ^BQN,2,7
    ^FDQA,P3511-PC2T-0000;Q10000;VA8130;L00000000001;T00000000001^FS
    ^CF0,45
