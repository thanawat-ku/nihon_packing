...
use App\Domain\PackingItem\Service\PackingItemFinder;
    ...
    public function __invoke(
        ...
        if ($rtPack[0]['pack_status'] != "COMPLETE") {
            ...
            if ($rtPack[0]['pack_status'] == "PRINTED" || $rtPack[0]['pack_status'] == "INVOICED" || $rtPack[0]['pack_status'] == "TAGGED") {
                ...
                $rowPackCpoItem = $this->sellCpoItemFinder->findPackCpoItems($searchPackCpoItem);
            ...
            $this->sellLabelUpdater->deletePackLabelApi($sellID);
            $this->sellCpoItemUpdater->deleteCpoItemInPackCpoItemApi($sellID);
