...
return function (App $app) {
    ...
    $app->post('/api/add_lot_defect', \App\Action\Api\DefectAddAction::class);
    $app->post('/api/delete_lot_defect', \App\Action\Api\DefectDeleteAction::class);
    $app->post('/api/edit_lot_defect', \App\Action\Api\DefectEditAction::class);
